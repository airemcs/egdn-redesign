...
export default function Footer() {
  return (
    <footer className="bg-footer-bg border-t border-border mt-12 sm:mt-24">
      <div className="mx-auto max-w-300 px-5 pt-9 pb-7 sm:px-6 sm:pt-24 sm:pb-10 lg:px-10">
        ...
        <div className="mt-7 border-t border-border pt-[18px] flex items-center justify-between text-[12px] text-text-muted sm:mt-16 sm:pt-6 sm:text-[13px]">
          ...
          <div className="flex gap-3">
            <a
              ...
              className="flex h-9 w-9 items-center justify-center rounded-full border border-border bg-surface text-text transition-all hover:text-brand hover:border-brand"
            >
